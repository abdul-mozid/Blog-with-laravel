...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <a href="{{route('author.post.create')}}" class="btn btn-primary wave-effect">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('author.post.edit',$post->id)}}" class="btn btn-success btn-sm">Edit</a>
                                            <a class="btn btn-sm btn-danger" onclick="event.preventDefault();
                                                        document.getElementById('delete-form-{{ $post->id }}').submit();">Delete</a> 
                                            <form class="form-inline" id="delete-form-{{ $post->id }}" action="{{route('author.post.destroy',$post->id)}}" method="POST">
                                                @csrf
                                                @method('delete')
                                            </form>
                                        </td>
